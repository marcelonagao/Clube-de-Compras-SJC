      ...
      <div className="w-full px-4 lg:px-8 mx-auto pt-6 pb-24 font-sans text-left">
        ...
        {CONFIG_APENAS_COLETA && (
          <div className="mb-6 space-y-4">
            {/* 👇 CARTÕES FINANCEIROS (ALTURA FIXA E BOTÃO INLINE) 👇 */}
            <div className="flex overflow-x-auto sm:grid sm:grid-cols-3 gap-3 pb-4 snap-x scrollbar-hide">
              
              {/* Card 1: Fatura Total */}
              <div className="bg-slate-800 text-white border border-slate-700 rounded-2xl p-4 shadow-sm flex flex-col justify-between min-w-[80vw] sm:min-w-0 snap-center text-left h-[105px]">
                <div className="flex justify-between items-start">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">📋 Total do Lote</p>
                    <span className="text-[9px] font-medium text-slate-500">Geral</span>
                </div>
                <h1 className="text-2xl font-black text-white leading-none truncate">R$ {totalGeralPolo.toFixed(2).replace('.',',')}</h1>
              </div>

              {/* Card 2: Caixa do JC */}
              <div className="bg-emerald-800 text-white border border-emerald-700 rounded-2xl p-4 shadow-sm flex flex-col justify-between min-w-[80vw] sm:min-w-0 snap-center text-left h-[105px]">
                <div className="flex justify-between items-start">
                ...
                {/* O TRUQUE: Valor e Botão na mesma linha! */}
                <div className="flex items-center justify-between gap-2">
                  <h1 className="text-2xl font-black text-white leading-none truncate">R$ {totalArrecadadoPolo.toFixed(2).replace('.',',')}</h1>
                  {totalArrecadadoPolo > 0 && (
                    <button onClick={handleEfetuarRepassePolo} className="bg-emerald-600 hover:bg-emerald-500 text-white font-black text-[10px] uppercase tracking-wider px-3 py-1.5 rounded-lg shadow-sm transition shrink-0 flex items-center">
                      Repassar <ArrowRight className="w-3 h-3 ml-1"/>
                    </button>
                  )}
                </div>
              </div>
              ...
              <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4 shadow-sm flex flex-col justify-between min-w-[80vw] sm:min-w-0 snap-center text-left h-[105px]">
                <div className="flex justify-between items-start">
                ...
                <h1 className="text-2xl font-black text-orange-800 leading-none truncate">R$ {totalAindaAReceber.toFixed(2).replace('.',',')}</h1>
              </div>
